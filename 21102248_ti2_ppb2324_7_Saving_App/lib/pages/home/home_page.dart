...
import 'package:saving_app_lanjutan/styles/text_style.dart';
              ...
              child: DraggableScrollableSheet(
                builder: (context, scrollController) {
                  return Container(
                    ...
                    padding:
                        const EdgeInsets.only(left: 30, right: 30, top: 21),
                    child: Stack(
                      children: [
                        Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                _transactionList(
                                  ...
                                  'assets/icons/trlangle-down.png',
                                  'Starbucks Drinks',
                                  'March 31, 12:25 PM',
                                  '- 115.000',
                                ),
